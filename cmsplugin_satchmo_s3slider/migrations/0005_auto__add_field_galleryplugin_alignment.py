...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GalleryPlugin.alignment'
        db.add_column('cmsplugin_galleryplugin', 'alignment', self.gf('django.db.models.fields.CharField')(default='left', max_length=8), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GalleryPlugin.alignment'
        db.delete_column('cmsplugin_galleryplugin', 'alignment')
