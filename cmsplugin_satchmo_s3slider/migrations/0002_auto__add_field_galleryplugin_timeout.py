...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GalleryPlugin.timeout'
        db.add_column('cmsplugin_galleryplugin', 'timeout', self.gf('django.db.models.fields.IntegerField')(default=3000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GalleryPlugin.timeout'
        db.delete_column('cmsplugin_galleryplugin', 'timeout')
