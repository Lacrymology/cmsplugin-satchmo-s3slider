...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductGalleryPlugin.product_category'
        db.add_column('cmsplugin_productgalleryplugin', 'product_category', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['product.Category']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductGalleryPlugin.product_category'
        db.delete_column('cmsplugin_productgalleryplugin', 'product_category_id')
    ...
    models = {
        ...
        'cmsplugin_satchmo_s3slider.productgalleryplugin': {
            ...
            'product_category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['product.Category']"}),
            'template': ('django.db.models.fields.CharField', [], {'default': "'cmsplugin_satchmo_s3slider/gallery.html'", 'max_length': '255'}),
